...
namespace DestinyCore
{
           ...
           where TEntity : IEntity<TPrimaryKey>
    {
        ...
        /// <returns>业务操作结果</returns>
        Task<OperationResponse> UpdateAsync<TInputDto>(TInputDto dto, Func<TInputDto, TEntity, Task> checkFunc = null, Func<TInputDto, TEntity, Task<TEntity>> updateFunc = null) where TInputDto :  IInputDto<TPrimaryKey>;
